...
The data sourced from [Hugging Face](https://huggingface.co/datasets/lukebarousse/data_jobs) containing detailed information on job titles, salaries, locations, and essential skills. I explore key questions such as the most demanded skills, salary trends, and the intersection of demand and salary in data analytics.
